...
export default function Developpement() {
  return (
    ...
    <div className="mx-5 my-3 text-lg">
        ...
        <Link  className='text-gray-600'>Developpement & IT</Link>
    </div>
    ...
    <div className="left">
      <p className='mx-8 my-10 text-xl'>Showing all 8 results</p>
    </div>
    <div className="right my-7">
    <button type="button" className="text-white text-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Filter</button>
