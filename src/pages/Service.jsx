...
export default function Service() {
  ...
  return (
    <main>
        <div className="mx-5 my-3 text-lg flex-col sm:flex-row space-x-4 p-4 ">
        ...
        <div className="relative left">
          <img src="images/bg-filter1.jpg" alt="" className='lg:h-full md:h-full sm:h-[20rem]'/>
           <div className="absolute inset-12">
           <h1 className='md:text-5xl sm:text-lg font-bold'>Design & Creative</h1>
